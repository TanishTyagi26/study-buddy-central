...
import { TrendingUp, Clock, Upload, Users, ArrowRight, BookOpen } from "lucide-react";
...
export default function HomePage() {
  ...
  const fetchNotes = async () => {
    ...
    const { data } = await supabase
      ...
      .select(`
        *,
        profiles:user_id(full_name, avatar_url, username, role)
      `)
  ...
  const fetchStats = async () => {
    ...
    setStats({ totalNotes: notesRes.count || 0, totalUsers: usersRes.count || 0 });
  };
        ...
        <div className="rounded-2xl gradient-hero p-5 text-white relative overflow-hidden">
          ...
          <div className="relative flex items-start justify-between gap-4">
            <div>
              ...
              <p className="text-white/70 text-sm mt-1">Discover and share study notes with your community</p>
              <div className="flex items-center gap-4 mt-4">
                <div className="text-center">
                  <p className="text-lg font-bold">{stats.totalNotes}</p>
            ...
            <Button
              variant="secondary"
              size="sm"
              className="bg-white/20 hover:bg-white/30 text-white border-0 shrink-0 hidden sm:flex"
        ...
        <section>
          ...
          {loading ? (
            ...
            <div className="bg-card rounded-2xl border border-border p-12 text-center">
              ...
              <Button className="gradient-primary text-white" onClick={() => navigate("/upload")}>
